...
\textbf{Languages:} Python, Java, R, SQL, HTML/CSS, JavaScript/React, \LaTeX, Stata, VBA \par
...
\textit{Research Apprentice} \hfill Jan 2021--Present
\begin{itemize}
	\item Develop and streamline R Shiny applications and markdown notebooks to showcase Open Policy Analysis.
	\item Assess and improve reproducibility for five papers using R, Stata, Python, and \LaTeX, working with authors
\end{itemize}\par
