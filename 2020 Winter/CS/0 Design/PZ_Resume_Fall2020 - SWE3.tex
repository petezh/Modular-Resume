...
\textit{Monster Project Consultant} \hfill Sep 2020--Present
\begin{itemize}
	\item Performed qualitative analysis on the marketing and flavor development strategies of Mosnter's competitors
	\item Leveraged sentiment analysis, time series modeling, and clustering to model trends in the beverage industry
\end{itemize}\par
...
\textbf{Tools} Git/Terminal, VS Code/IntelliJ/Android Studio, WordPress, Electron, Jupyter
