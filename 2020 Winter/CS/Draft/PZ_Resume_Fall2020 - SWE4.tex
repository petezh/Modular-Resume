...
\textit{Quantitative Consultant} \hfill Sep 2020--Present
\begin{itemize}
	\item Analyzed social media and Google Trends data to forecast consumer interest in 55 groups of products
	\item Performed demand forecasting on 4.5M rows of CPG sales data to find successful products and launches
\end{itemize}\par
...
\textbf{Languages} Python, R w/ Shiny, Java, SQL Lite/MySQL, HTML/CSS/Javascript, MATLAB, \LaTeX \par
