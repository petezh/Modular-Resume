...
\textit{Computer Science and Economics B.A.}; 4.00 Cumulative GPA \hfill Class of 2023
\begin{itemize}
	\item \textbf{Coursework} Data Structures, Discrete Math and Probability, Functional Programming, Linear Algebra, Statistics
	\item \textbf{Activities} Debate Society at Berkeley, Computer Science Mentors, Berkeley Economic Review
\end{itemize}
