...
\textit{Data Science Intern} \hfill Jan 2021--Present
\begin{itemize}
	\item Detect anomalies and trends in food waste datasets to create actionable advice for partnered food vendors
	\item Craft intuitive R Shiny and D3 visualizations that provide meaningful feedback to non-technical users
\end{itemize}\par

\textbf{Monster Energy \hfill Berkeley, CA}\par

\textit{Contract Consultant} \hfill Sep 2020--Dec 2020
\begin{itemize}
