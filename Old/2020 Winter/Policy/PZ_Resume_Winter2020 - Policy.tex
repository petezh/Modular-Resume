...
\begin{itemize}
	\item \textbf{Coursework} Data Structures, Information Device Design, Functional Programming, Linear Algebra, Statistics
	\item \textbf{Activities} Voyager Consulting, Debate Society at Berkeley, Berkeley Economic Review, Computer Science Mentors
\end{itemize}
...
\begin{itemize}
	...
	\item Deploy data scraping, sentiment analysis, demand forecasting identify promising products for development
\end{itemize}\par


\textbf{Berkeley Economic Review \hfill Berkeley, CA}\par
\textit{Writer} \hfill Sep 2020--Present
\begin{itemize}
	\item Draw on academic literautre and 
	\item 
\end{itemize}\par
