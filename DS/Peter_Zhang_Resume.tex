...
\textit{Computer Science and Economics B.A.}; 4.00 Cumulative GPA \hfill Class of 2023\par
Coursework: Data Science, Data Structures, Probability, Statistics, Linear Algebra, Macroeconomics, Microeconomics\par
Activities: Voyager Consulting, Debate Society of Berkeley, Computer Science Mentors, Berkeley Economic Review

\resumesection{Skills}

\textbf{Languages} Python, R, Java, SQL Lite/MySQL, HTML/CSS/JavaScript, MATLAB, \LaTeX, Stata \par
...
\textit{Research Assistant} \hfill May 2020--Sep 2020
\begin{itemize}
...
\begin{itemize}
	\item Scraped 200k+ outcomes from debate tournaments and 25k+ publicly posted debate cases
